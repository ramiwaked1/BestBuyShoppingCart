...
var App = function () {
  function App() {
    ...
    (0, _jquery2.default)("#menu a").click(function (event) {
      // your code goes here
      var path = (0, _jquery2.default)(event.target).data('path');
      _this.flkty.remove((0, _jquery2.default)('.products'));

      _this.initBBCall(path);
    });
  }

  _createClass(App, [{
    key: 'initBBCall',
    value: function initBBCall(path) {
      var _this2 = this;
